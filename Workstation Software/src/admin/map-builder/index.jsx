...
export default function AdminMapBuilder(props) {
  ...
  function sensorToBoard(afterSubmit) {
    ...
    for (const square in afterSubmit){
      ...
      if(afterSubmit[square]==="board"){
        ...
        if(temp>=limit){
          flag=true;
          if(localStorage.getItem("checkOne")==="true"){
            setResult(oldArray => [...oldArray, "1"]);
          }
    ...
    for(const square in afterSubmit){
      ...
      if(afterSubmit[square]==="board"){
        ...
        if(temp && localStorage.getItem("checkedTen")==="true"){
          ...
          setResult(oldArray => [...oldArray, "10"]);
        }
      }
    }
  }
  function sensorConnectToSensor(twoDarray){
    ...
    // }
    if(notificationPosition.length>0 && localStorage.getItem("checkedTwo")==="true"){
      setResult(oldArray => [...oldArray, "2"]);
    }
  }
  function sensorNotConnected(afterSubmit) {
    for (const square in afterSubmit ){
      ...
      if(sensor.includes(afterSubmit[square])){
        ...
        if(!temp && localStorage.getItem("checkedThree")==="true"){
          setResult(oldArray => [...oldArray, "3"]);
        }
    ...
    <div className="tiles">
      ...
      <div>
        <button className="submit" onClick={async () => {
          ...
          setResult([]);
          if(localStorage.getItem("checkOne")==="true"){
            setIcon(oldArray => [...oldArray, "1"]);
            setIcon(oldArray => [...oldArray, "101"]);
          }
          if(localStorage.getItem("checked100")==="true"){
            setIcon(oldArray => [...oldArray, "100"]);
          }
          if(localStorage.getItem("checkedTwo")==="true"){
            setIcon(oldArray => [...oldArray, "2"]);
          }
          if(localStorage.getItem("checkedThree")==="true"){
            setIcon(oldArray => [...oldArray, "3"]);
          }
          if(localStorage.getItem("checkedFour")==="true"){
            setIcon(oldArray => [...oldArray, "4"]);
          }
          if(localStorage.getItem("checkedFive")==="true"){
            setIcon(oldArray => [...oldArray, "5"]);
          }
          if(localStorage.getItem("checkedSix")==="true"){
            setIcon(oldArray => [...oldArray, "6"]);
          }
          if(localStorage.getItem("checkedSeven")==="true"){
            setIcon(oldArray => [...oldArray, "7"]);
          }
          if(localStorage.getItem("checkedeight")==="true"){
            setIcon(oldArray => [...oldArray, "8"]);
          }
          if(localStorage.getItem("checkedNine")==="true"){
            setIcon(oldArray => [...oldArray, "9"]);
          }
          if(localStorage.getItem("checkedTen")==="true"){
            setIcon(oldArray => [...oldArray, "10"]);
            setIcon(oldArray => [...oldArray, "110"]);
          }
          if(localStorage.getItem("checkedEleven")==="true"){
            setIcon(oldArray => [...oldArray, "11"]);
          }
          if(localStorage.getItem("checkedTwelve")==="true"){
            setIcon(oldArray => [...oldArray, "12"]);
          }
          if(localStorage.getItem("checked13")==="true"){
            setIcon(oldArray => [...oldArray, "13"]);
          }
          if(localStorage.getItem("checked14")==="true"){
            setIcon(oldArray => [...oldArray, "14"]);
          }
          if(localStorage.getItem("checked15")==="true"){
            setIcon(oldArray => [...oldArray, "15"]);
          }
          ...
          if(roomInRoom && localStorage.getItem("checkedEleven")==="true"){
            setResult(oldArray => [...oldArray, "11"]);
          }
          ...
          sensorPerRoom.forEach((elem)=>{
            if(elem[5].length>0){       //have light-detector in room
              elem[5].forEach((element)=>{
                ...
                if(!flag && localStorage.getItem("checkedSix")==="true"){
                  setResult(oldArray => [...oldArray, "6"]);
                }
              })
            }
          });
